...
CREATE TABLE KKB_ORDER (ID VARCHAR(50) NOT NULL, AMOUNT DOUBLE, CLOSED DATETIME, CONSUMER_EMAIL VARCHAR(255), CONSUMER_LANGUAGE VARCHAR(255), CONSUMER_NAME VARCHAR(255), CREATED DATETIME, CURRENCY VARCHAR(255), EXTERNAL_ID VARCHAR(100), PAID DATETIME, PAYMENT_REFERENCE VARCHAR(255), STATUS VARCHAR(100), UPDATED DATETIME, CART_DOCUMENT_ID INTEGER, REQUEST_DOCUMENT_ID INTEGER, RESPONSE_DOCUMENT_ID INTEGER, PRIMARY KEY (ID))
