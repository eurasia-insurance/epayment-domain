...
CREATE TABLE PAYMENT (ID INTEGER AUTO_INCREMENT NOT NULL, DTYPE VARCHAR(31), AMOUNT DOUBLE, CREATED DATETIME, CURRENCY VARCHAR(255), PAYER_NAME VARCHAR(255), REFERENCE VARCHAR(255), UPDATED DATETIME NOT NULL, PRIMARY KEY (ID))
